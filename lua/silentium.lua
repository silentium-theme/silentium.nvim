...
function M.colorscheme()
    ...
    hl("TabLine", { fg = M.colors.white, bg = M.colors.dark_gray })
    hl("TabLineFill", { fg = M.colors.white, bg = M.colors.dark_gray })
    hl("TabLineSel", { fg = M.colors.dark, bg = M.colors.accent })
	hl("Title", {})
	hl("Todo", {})
	hl("Type", {})
